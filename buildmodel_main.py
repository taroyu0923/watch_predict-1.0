...
def main():
    ...
    try:
        ...
        # data input
        acce_file_path = 'D:/WORK4/watch_predict-1.0/input_data/Accelerometer_Merge_Log.csv' # you need to add acceleration data's path here (csv file)
        gyro_file_path = 'D:/WORK4/watch_predict-1.0/input_data/Gyro_Merge_Log.csv' # you need to add Gyroscope data's path here (csv file)
