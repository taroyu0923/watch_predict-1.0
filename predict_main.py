...
rredict_result: model(pkl), data(Double array)
...
def main():
	...
	'''
	# input data
	acce_test_path = 'D:/WORK4/watch_predict-1.0/input_data/Accelerometer_Merge_Log.csv'		# input your test data path
	gyro_test_path = 'D:/WORK4/watch_predict-1.0/input_data/Gyro_Merge_Log.csv'		# input your test data path

	# input model
	acce_model_path = 'D:/WORK4/watch_predict-1.0/saved_model/md1_acce.pkl'		# input your model path
	gyro_model_path = 'D:/WORK4/watch_predict-1.0/saved_model/md2_gyro.pkl'		# input your model path
